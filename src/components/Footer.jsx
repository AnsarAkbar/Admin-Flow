  ...
  return (
    <div id="app">
      <footer className="bg-gray-800 text-white py-12">
          ...
          <div className="flex justify-between md:justify-start">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:text-gray-400">Commerce</a></li>
                <li><a href="#" className="hover:text-gray-400">Insights</a></li>
              </ul>
            </div>
        ...
        {/* Footer Bottom */}
        <div className="bg-gray-700 py-4 mt-12 text-center text-sm">
